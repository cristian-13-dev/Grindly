...
import {loginSchema, LoginValues, registerSchema, RegisterValues} from "@/validations/auth";
...
export default function LoginForm() {
  ...
  return <div className="bg-white border border-neutral-300 p-8 rounded-lg">
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmitHandler)} className="space-y-5">
        ...
        <div className="flex flex-col space-y-3">
          ...
          >
            {isSubmitting ? (
              <><Spinner/> <span>{mode === 'login' ? 'Signing in...' : 'Creating account...'}</span></>
            ) : (
